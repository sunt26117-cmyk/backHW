...
const P: Record<EngineeringDomain, DomainProfile> = {
  ...
  EMC_ESD: {
    ...
    measurements:[
      ...
      {key:'tvsClampingVoltageV',label:'TVS钳位残压',unit:'V',description:'保护器件钳位电压(器件规格)',tag:'SPEC'},
    ],
  ...
  COMPONENT: {
    ...
    measurements:[
      ...
      {key:'primaryRdsOnMilliOhm',label:'一供 Rds(on)',unit:'mΩ',description:'首选器件导通电阻',tag:'SPEC'},
      {key:'secondaryRdsOnMilliOhm',label:'二供 Rds(on)',unit:'mΩ',description:'二供器件导通电阻',tag:'SPEC'},
      {key:'primaryQgNc',label:'一供 Qg',unit:'nC',description:'首选器件栅极电荷',tag:'SPEC'},
      {key:'secondaryQgNc',label:'二供 Qg',unit:'nC',description:'二供器件栅极电荷',tag:'SPEC'},
      {key:'primaryQrrNc',label:'一供 Qrr',unit:'nC',description:'首选器件反向恢复电荷',tag:'SPEC'},
      {key:'secondaryQrrNc',label:'二供 Qrr',unit:'nC',description:'二供器件反向恢复电荷',tag:'SPEC'},
      {key:'primaryRthJcCPerW',label:'一供 Rth(j-c)',unit:'℃/W',description:'首选器件结壳热阻',tag:'SPEC'},
      {key:'secondaryRthJcCPerW',label:'二供 Rth(j-c)',unit:'℃/W',description:'二供器件结壳热阻',tag:'SPEC'},
      {key:'componentPartNumber',label:'器件型号',description:'PCN/二供评估的目标器件',tag:'CONTEXT'},
      {key:'supplierName',label:'供应商',description:'变更/替代供应商名称',tag:'CONTEXT'},
      {key:'pcnChangeDescription',label:'PCN变更内容',description:'晶圆厂/封装/工艺变更的具体描述',tag:'CONTEXT'},
    ],
